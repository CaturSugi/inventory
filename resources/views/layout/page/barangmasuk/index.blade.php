...
@section('header')
    <div class="page-title">
        <h1>Barang Masuk <small>Barang Listing</small></h1>
    </div>
@endsection
            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <span class="hidden-480">
                        New Barang Masuk</span>
                    </a>
                    @include('layout.page.barangmasuk.create') <!-- Include the modal file here -->
                        ...
                        <tbody>
                            @foreach ($masuk as $item)
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        {{ $item->barang_id ? \App\Models\Barang::find($item->barang_id)->namabarang ?? '-' : '-' }}
                                    </td>
                                    <td>
                                        {{ $item->jumlah }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <!-- Edit Modal -->
                                        @include('layout.page.barangmasuk.edit') <!-- Include the modal file here -->
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Apakah Anda yakin ingin menghapus <strong>{{ $item->namabarang }}</strong>?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                        <form action="{{ route('barangmasuk.delete', $item->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
