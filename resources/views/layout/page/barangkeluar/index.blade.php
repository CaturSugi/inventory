...
@section('header')
    <div class="page-title">
        <h1>Barang Keluar <small>Barang Listing</small></h1>
    </div>
@endsection
            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <span class="hidden-480">
                        New Barang Keluar </span>
                    </a>
                    @include('layout.page.barangkeluar.create') <!-- Include the modal file here -->
                            ...
                            @foreach ($keluar as $item)
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <!-- Edit Modal -->
                                        @include('layout.page.barangkeluar.edit') <!-- Include the modal file here -->
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{ route('barangkeluar.delete', $item->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
